...
<body>
    ...
    <main>
        ...
        <h2>
            ...
            <span class="hg-ygrn">Imagination</span>
        </h2>
        <div class="index-buttons">
            <div class="index-chat"></div>
            <div class="index-quick"></div>
        </div>
        <div class="index-contents">
            <h4>Steam Deck OLED</h4>
            <a href="#">지금 대여하기</a>
            <p>PS5 | XBOX | NINTENDO | VR | <span>STEAM DECK</span></p>
        </div>
    </main>
</body>
